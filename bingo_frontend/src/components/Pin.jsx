...
{postHoverd && (
        ...
        <div className='flex items-center justify-between '>
           <div className='flex gap-2'>
                ...
                className='bg-white w-9 h-9 rounded-xl flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none'
                >
            ...
            <div className='flex justify-between items-center gap-w2 w-full'>
              {destination && (
                <a  
                  href='{destination}'
                  target='_blank'
